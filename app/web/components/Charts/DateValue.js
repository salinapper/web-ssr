...
export default class DateValueChart extends Component {
  ...
  updateChart = (props) => {
    const { data_zoom_start, data_zoom_end, start_date, end_date, tickSplit, colors, yAxisDatas, paddingLeft, paddingTop, paddingBottom, scaleType, legend, formatter, notMerge } = props;
  ...
  componentWillReceiveProps(nextProps) {
    if (
      ...
      || this.props.customOptions !== nextProps.customOptions
